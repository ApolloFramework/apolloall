...
class Camellia(CMakePackage):
    ...
    depends_on('trilinos+amesos2+belos+epetra+epetraext+exodus+ifpack+ifpack2+intrepid+intrepid2+kokkos+ml+muelu+nox+sacado+shards+teuchos+tpetra+zoltan+mumps+superlu-dist+hdf5+zlib+pnetcdf+yaml-cpp@12.12.1:')
